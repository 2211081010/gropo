   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         ...
         <div class="pull-right">
            <a href="/admin/lokasi/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
         </div>
      </div>
      ...
      <table class="table table-striped table-bordered data-table hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td class="text-center" width="15%">
                  <a href="/admin/lokasi/edit/{{$data->id}}" class="btn btn-success btn-xs">
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="form-group" style="font-size: 17px;">
               ...
               <input class="form-control" value="{{$data->koordinat}}" readonly>
            </div>
            <div class="form-group" style="font-size: 17px;">
               <label>Foto</label><br>
               @if($data->foto)
