   ...
   <div class="pd-20 card-box mb-30">
      ...
      <form action="/admin/lokasi/create" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
            ...
            <input type="text" autofocus name="nama" required class="form-control" placeholder="Masukkan Nama lokasi .....">
         </div>
         <div class="form-group">
            <label>Alamat<span class="text-danger">*</span></label>
            <input type="text" autofocus name="alamat" required class="form-control" placeholder="Masukkan Alamat .....">
         </div>
         <div class="form-group">
            <label>Titik Koordinat<span class="text-danger">*</span></label>
            <input type="text" autofocus name="koordinat" required class="form-control" placeholder="Masukkan Titik Koordinat .....">
         </div>
         <div class="form-group">
            <label>Foto<span class="text-danger">*</span></label>
            <input type="file" autofocus name="foto" required>
         </div>
