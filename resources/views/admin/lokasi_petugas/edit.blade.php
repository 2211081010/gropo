...
<div class="min-height-200px">
         ...
         <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Edit Data Lokasi Petugas</li>
               </ol>
            </nav>
         </div>
      </div>
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-edit-1"></i> Edit Data Lokasi Petugas</h2>
         </div>
      ...
      <form action="/admin/lokasi_petugas/update/{{$lokasi_petugas->id}}" method="POST">
         @csrf
         ...
         <div class="form-group">
            ...
            <select name="id_lokasi" class="form-control" required>
                ...
                @foreach($lokasi as $lks)
                    <option value="{{ $lks->id }}"
                        {{ $lokasi_petugas->id_lokasi == $lks->id ? 'selected' : '' }}>
                        {{ $lks->nama }}
                    </option>
                @endforeach
            </select>
         ...
         <div class="form-group">
            ...
            <select name="id_petugas" class="form-control" required>
                ...
                @foreach($petugas as $ptg)
                    <option value="{{ $ptg->id }}"
                        {{ $lokasi_petugas->id_petugas == $ptg->id ? 'selected' : '' }}>
                        {{ $ptg->nama }}
                    </option>
                @endforeach
            </select>
