...
<div class="min-height-200px">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Lokasi Petugas</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="pull-left">
                <h2 class="text-primary h2"><i class="icon-copy dw dw-list"></i> List Data Lokasi Petugas</h2>
            </div>
            <div class="pull-right">
                <a href="/admin/lokasi_petugas/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
        </div>
        ...
        <table class="table table-striped table-bordered data-table hover">
            ...
            <tbody>
                @foreach($lokasi_petugas as $no => $data)
                <tr>
                    <td class="text-center">{{ $no + 1 }}</td>
                    <td>{{ $data->nama_lokasi }}</td>
                    <td>{{ $data->nama_petugas }}</td>
                    <td class="text-center" width="15%">
                        <a href="/admin/lokasi_petugas/edit/{{$data->id}}" class="btn btn-success btn-xs" data-toggle="tooltip" title="Edit Data">
...
<!-- Modal Hapus -->
@foreach($lokasi_petugas as $data)
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <a href="/admin/lokasi_petugas/delete/{{$data->id}}">
